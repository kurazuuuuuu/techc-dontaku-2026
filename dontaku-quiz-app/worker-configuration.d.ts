/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 40ea5324521b67fb48446a9535fd3373)
// Runtime types generated with workerd@1.20260420.1 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
	}
	interface Env {
		DONTAKU_SEARCH: AiSearchInstance;
		AI: Ai;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "AI_GATEWAY_TOKEN">> {}
}
